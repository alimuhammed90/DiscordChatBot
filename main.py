...
async def elisi(ctx):
    fikirler = [
        "Plastik şişelerden kalemlik yap.",
        "Eski yoğurt kaplarında saksı yap.",
        "Pet şişeleri keserek kuşlar için yemlik yap.",
        "Pet şişeden oyuncak yap",
        'Dişimizi fırçalarken su yu açık bırakma.',
        'Çöplerimizi düzenli bir şekilde çöp kutusuna atmak.',
        'suyu sıcak ve soğuk a ayarlarken giden suyu bir kovaya koyup onu kullanabilirsin',
        'Yemediğimiz yemeği çöpe atmak yerine sokaktaki hayvanlara verebilirsin.',
        'Doğaya bırakılmış atıkları toplamak.',
        'Evde fazlalık gördüğün giysileri veya küçülen giysileri sokaklarda bulunan geri dönüşüm kutusuna atabilirsin',
        'Evde kullanılmayan şarj aletlerini fişde takılı bırakmamak.',
    ]
